 ...
 */
public class Homework5Checkpoint2CorrectnessTest extends TestCase {
    public void testUsefulParScoring1() {
        ...
        Homework5Checkpoint1CorrectnessTest.kernel(xLength, yLength, seqConstructor, parConstructor, false);
    }
